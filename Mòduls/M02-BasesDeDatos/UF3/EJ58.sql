...
if(new.letra = 'A') then
update prova_puntuacio_seg set puntuacio2 = new.puntuacio where letra2 = new.letra;
elseif(new.letra = 'B') then
update prova_puntuacio_seg set puntuacio2 = new.puntuacio where letra2 = new.letra;
elseif(new.letra = 'C') then
update prova_puntuacio_seg set puntuacio2 = new.puntuacio where letra2 = new.letra;
elseif(new.letra = 'D') then
update prova_puntuacio_seg set puntuacio2 = new.puntuacio where letra2 = new.letra;
elseif(new.letra = 'E') then
update prova_puntuacio_seg set puntuacio2 = new.puntuacio where letra2 = new.letra;
end if;
end if;
end
