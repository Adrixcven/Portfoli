 ...
 * @author Adrix
 */
public class el2dmola2 {

    public static void main(String[] args) {

        Scanner in = new Scanner(System.in);
        int[][] nom = new int[10][50];
        int num = 1, cont = 0, contador = 0, si, num1, num2;
        double rand, max = 0;
        ...
        for (int i = 0; i < nom.length; i++) {
            ...
            for (int j = 0; j < nom[i].length; j++) {
                ...
                System.out.print((String.format("%.2f", rand)) + " ");
                if (rand > max) {
                    max = rand;
                }
                cont += rand;
        ...
        System.out.println("El numero mas grande es " + (String.format("%.2f", max)));
